...
public class MyWlGlRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        LogUtil.e(TAG, "onSurfaceChanged :   --> " + "onSurfaceChanged, width:" + width + ",height :" + height);
        sWidth = width;
        sHeight = height;
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (codecType == 1) {
            renderMediacodec();
            LogUtil.v(TAG, "onDrawFrame: mediaocdec.......");
        } else if (codecType == 0) {
            renderYuv();
            LogUtil.v(TAG, "onDrawFrame: yuv.......");
        } else {
            LogUtil.d(TAG, "onDrawFrame  --> renderStop....... ");
            renderStop();
        }
...
//        LogUtil.e(TAG, "onFrameAvailable :   --> ");
    ...
    private void renderYuv() {
        if (w > 0 && h > 0 && y != null && u != null && v != null) {
            ...
            LogUtil.e(TAG, "renderYuv :  renderFFmcodec --> ");
